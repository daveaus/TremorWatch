        ...
        serviceScope.launch(Dispatchers.IO) {
            try {
                ...
                val entity = com.opensource.tremorwatch.phone.data.TrainingLabelEntity(
                    ...
                    bandPower2to4Hz = sample.bandPower2to4Hz,
                    bandPower4to6Hz = sample.bandPower4to6Hz,
                    bandPower6to8Hz = sample.bandPower6to8Hz,
                    bandPower8to10Hz = sample.bandPower8to10Hz,
                    bandPower10to12Hz = sample.bandPower10to12Hz,
                    bandPower12to14Hz = sample.bandPower12to14Hz,
